...
HD_PWD='C:/Users/tj/Documents/Xilinx_Projects/Generic_QSPI/Generic_QSPI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log QSPI_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source QSPI_top.tcl
